...
# For example, call 911 if: there's a fire. someone has passed out. someone suddenly seems very 
# sick and is having a hard time speaking or breathing or turns blue.""",
...
# len_payload = len(random_context+inp)	
